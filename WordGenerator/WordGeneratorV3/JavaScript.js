/*
generateWord() concatenates a string, with a length specified by the user through a text label, of letters from the English alphabet randomly chosen by the Math.random function and displays them on the page as a paragraph element on the page with a nested function clicked()
*/
...
const text1 = document.getElementById("lengthSubmitted");
text1.addEventListener("keyup", function(validateEnter){
    if (validateEnter.code === "Enter") {
        getLength();
    }
});